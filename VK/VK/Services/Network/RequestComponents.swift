...
enum RequestComponents {
    ...
    static let clientParameterValue = "51502782"
    ...
    static let scopeParameterValue = "friends,groups,photos,wall"
    static let startTime = "startTime"
    static let startTimeValue = "start_time"
...
enum Path: String {
    ...
    case news = "https://api.vk.com/method/newsfeed.get"
}
